import 'package:clientx/screens/client/edit_profile.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            children: [
              // Header with Back Button (Visual only as per design, but functional if needed)
              Padding(
                ...
                child: Row(
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        // Handle back navigation or remove if main tab
                      },
                    ),
                  ],
                ),
                      ...
                      children: [
                        Container(
                          ...
                          child: const CircleAvatar(
                            radius: 56,
                            backgroundColor: Color(0xFF3F6EB4), // Blueish color
                            child: Icon(
                              Icons.person,
                              size: 60,
                              color: Colors.white,
  ...
  Widget _buildMenuOption(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFFE8EEF6), // Very light blueish grey for buttons
